...
ALTER TABLE BBS
 ...
 (USER_NO, ID, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, AGREE_CODE, JOIN_DATE)
VALUES
 (USERS_SEQ.NEXTVAL, 'user01', ' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', '발표용', 'F', 'owo667@naver.com', '01011111111', '1990', '1010', '3', SYSDATE);
  INSERT INTO USERS
 (USER_NO, ID, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, AGREE_CODE, JOIN_DATE)
VALUES
 (USERS_SEQ.NEXTVAL, 'user02', ' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', '수정용', 'F', 'user@web.com', '01011111111', '1990', '1010', '3', SYSDATE);
